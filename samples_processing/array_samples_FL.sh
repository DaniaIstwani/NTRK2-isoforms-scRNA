#!/bin/bash
#SBATCH --job-name=dropest_job_FL 
#SBATCH --output=dropest_output_FL.txt
#SBATCH --error=dropest_error_FL.txt
#SBATCH --nodes=1
...
samples=("10X52_1.bam.1" "10X52_3.bam.1" "10X50_1.bam.1" "10X19_2.bam.1" "10X05_1.bam.1" "10X52_4.bam.1" "10X49_1.bam.1" "10X52_2.bam.1" "10X20_2.bam.1" "10X24_2.bam.1" "10X06_2.bam.1" "10X35_2.bam.1" "10X20_1.bam.1" "10X36_2.bam.1" "10X36_1.bam.1" "10X38_2.bam.1" "10X35_1.bam.1" "10X06_1.bam.1" "10X07_1.bam.1" "10X38_1.bam.1" "10X87_2.bam.1" "10X87_1.bam.1")

mf_config="~/.Arcitecta/mflux.cfg"

sample_path="/projects/proj-6030_ntrk2isoforms-1128.4.1092/samples"

results_path="/projects/proj-6030_ntrk2isoforms-1128.4.1092/count_matrices/cm_FL"

output_file="/data/gpfs/projects/punim2183/samples_processing/count_matrix_files/FL/count_matrix.rds"

gtf_file="/data/gpfs/projects/punim2183/samples_processing/FL.gtf"
