#!/bin/bash
#SBATCH --array=0-3 
#SBATCH --output=dropest_output_FL_a.txt
#SBATCH --error=dropest_error_FL_a.txt
#SBATCH --nodes=1
...
samples= (10X19_2.bam.1 10X05_1.bam.1 10X05_2.bam.1 10X50_3.bam.1)
...
sample="${samples[$SLURM_ARRAY_TASK_ID]}"  # Select sample based on job array index
