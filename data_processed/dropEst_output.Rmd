...
```
Write a function to read count matrices from a directory and create Seurat objects:
...
seurat_objects_orig <- read_rds_to_seurat("/data/gpfs/projects/punim2183/samples_processing/orig")

seurat_objects_trunc <- read_rds_to_seurat("/data/gpfs/projects/punim2183/samples_processing/trunc")

seurat_objects_FL <- read_rds_to_seurat("/data/gpfs/projects/punim2183/samples_processing/FL")
...
```{r}
cell.counts_1 <- readRDS("/data/gpfs/projects/punim2183/samples_processing/count_matrix.rds_10X04_2.bam.1_orig_s.gtf")
